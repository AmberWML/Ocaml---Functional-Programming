...
(*  The Stream functor should provide implementations of the functions head, tail, take, filter
 , map, and zip. We have seen implementations of these before so it is just a matter of
  packaging them up in a module. Part of this *)
  val head: 'a t -> 'a
  val tail: 'a t -> 'a t
